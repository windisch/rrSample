...
computeCellBounds <- function(u, constMat, type = "upper") {
    .Call('rrSample_computeCellBounds', PACKAGE = 'rrSample', u, constMat, type)
}
...
estimateMixing <- function(u, constMat, moves, diam, nAdaptedMoves = "", nIntPoints = "", tol = 0.25, type = "TVD") {
...
latticeComplement <- function(constMat) {
    .Call('rrSample_latticeComplement', PACKAGE = 'rrSample', constMat)
}
